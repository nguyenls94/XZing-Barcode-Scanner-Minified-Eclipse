...
public class DemoHomeActivity extends Activity {
	...
	public void scanBarcodeFragment(View view) {
		Intent intent = new Intent(this, FragmentScannerActivity.class);
	...
	public void scanToolbar(View view) {
		new IntentIntegrator(this).setCaptureActivity(
				ToolbarCaptureActivity.class).initiateScan();
	}

	public void scanCustomScanner(View view) {
		new IntentIntegrator(this).setCaptureActivity(
				CustomScannerActivity.class).initiateScan();
	}
